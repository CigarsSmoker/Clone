The example below demonstrates how to create rules within uMatrix for either domain restricted or a globally allowed setting to achieve user desired functionality (_e.g._ The user wants to be able to always play embedded youtube videos on a website) 
